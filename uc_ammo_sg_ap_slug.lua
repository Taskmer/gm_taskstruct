...
att.Description = [[A single heavy projectile with a a penetrator of hardened steel, tungsten, or tungsten carbide.omparable in performance to a high-caliber rifle cartridge at close to medium range.\nUpon impact on a hard target, the case is destroyed, but the penetrator continues its motion and penetrates the target.
